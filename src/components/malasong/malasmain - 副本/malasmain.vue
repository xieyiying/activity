        ...
        <div class="main_page_top">
            ...
            <div class="main_page_info">
                ...
                <a href="" class="linkedme"  id="openAPP5"  @click="jumpApp">
                    <div class="match_comments"><span class="check_comments">查看赛事评论</span><img src="../total_img/little_icon.png" alt="" class="comment_img"></div>
                </a>
            </div>
       ...
       created:function () {
        ...
        methods:{ 
            ...
            getinfo(){
                ...
                $.ajax({
                    type:'POST', 
                    url: "https://app.marathonbm.com/app/mls/article",
                    //url: "https://ceshiweb.hpaopao.com/app/mls/article",
                    //url:'https://192.168.2.9:8082/app/mls/article',
                    dataType:'JSON',
                    data:request,
